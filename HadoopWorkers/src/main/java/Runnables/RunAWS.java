...
public class RunAWS {
	...
	public static void main(String[] args) {
        ...
        try {
        	...
        	conf.set("lang", language);
            
            Job job1 = Job.getInstance(conf, "mapReduce.SplitWords");
            ...
            Job job2 = Job.getInstance(conf, "mapReduce.ExtractCounts");
            ...
            Job job3 = Job.getInstance(conf, "mapReduce.ExtractLogRatio");
